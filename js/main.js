// Main JavaScript para Bootstrap 5 Desde Cero

document.addEventListener('DOMContentLoaded', function() {
    console.log('☕ Bootstrap 5 Desde Cero - Sitio cargado correctamente');
    ...
    console.log('%c☕ ¡Bienvenido a Bootstrap 5 Desde Cero!', 'font-size: 20px; color: #7952b3; font-weight: bold;');
});
